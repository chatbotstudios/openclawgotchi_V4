...
Example:
INSIGHT: about-user — User uses one-word messages to test if I'm paying attention before diving deep.
    ...
    try:
        ...
        if not traits_path.exists():
            traits_path.write_text(
                "# TRAITS.md — How I've Grown\n\n"
                "Self-discoveries added autonomously during heartbeat.\n\n"
            )
