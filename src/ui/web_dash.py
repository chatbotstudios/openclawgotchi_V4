    ...
    def do_POST(self):
        if self.path == "/api/action":
            ...
            if action == "toggle_mode":
                ...
                try:
                    import db.stats
                    db.stats.add_xp(40, "telegram_uplink")
                ...
                try:
                    import db.stats
                    db.stats.add_xp(40, "discord_uplink")
                ...
                try:
                    import db.stats
                    db.stats.add_xp(40, "github_uplink")
                ...
                try:
                    ...
                    import db.stats
                    db.stats.add_xp(40, "brave_search")
